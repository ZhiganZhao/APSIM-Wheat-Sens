---
params:
    para: !r list(text = 'PotentialExtinctionCoeff', name =  "[Leaf].ExtinctionCoeff.PotentialExtinctionCoeff.XYPairs.Y", href = "PotentialExtinctionCoeff.html", level = c("0.3, 0.3", "0.5, 0.5", "0.7, 0.7"))
---
...
```{r configuration}
data.frame(Cultivar = paste0('Dummy', seq(along = para$level)),
           Level = para$level) %>% 
    kable()
